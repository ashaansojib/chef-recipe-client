...
const ChefRecipe = () => {
    ...
    return (
        <div>
            ...
            <div className='detail-container'>
                <div className='detail-bg'>
                    <div className='my-container lg:flex justify-between items-center h-full'>
                        ...
                        <div>
                            <LazyLoad><img className='lg:w-[450px] lg:h-[390px] py-2 px-4 bg-slate-500 bg-transparent' src={chef_image} alt="" /></LazyLoad>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* latest recepie card */}
            <div className='lg:w-[900px] mx-auto grid lg:grid-cols-3 md:grid-cols-2 lg:gap-2 justify-center py-10 px-2'>
                <div className='p-4'>
                    <LazyLoad><img className='w-full h-[250px]' src={image1} alt="" /></LazyLoad>
                ...
                <div className='p-4'>
                    <LazyLoad><img className='w-full h-[250px]' src={image2} alt="" /></LazyLoad>
                    <div className='p-4 border'>
                        <h2>{recipe2}</h2>
                        <div className='flex justify-between'>
                ...
                <div className='p-4'>
                    <LazyLoad><img className='w-full h-[250px]' src={image3} alt="" /></LazyLoad>
                    <div className='p-4 border'>
                        <h2>{recipe3}</h2>
                        <div className='flex justify-between'>
